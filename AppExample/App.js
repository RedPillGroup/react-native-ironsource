    ...
    <View style={styles.container}>
      <Button
        ...
        onPress={async () => {
          ...
          await Ironsource.initIronsourceSDK(
            Platform === 'ios' ? 'a8de03dd' : 'a392e26d',
            'demoapp',
            {activateIntegrationHelper: true},
          );
        }}
      />
      <Button
      ...
      />
      <Button
        title={'call is rewarded'}
        onPress={async () => {
          console.log('Ironsource is rewarded video available called');
          console.log(
            'Ironsource is rewarded video available ?',
      ...
      />
      <Button
        title={'call is interstitial'}
        onPress={async () => {
          console.log('Ironsource is interstitial available called');
          console.log(
            'Ironsource is interstitial available ?',
